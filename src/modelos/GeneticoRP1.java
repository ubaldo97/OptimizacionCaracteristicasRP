...
public class GeneticoRP1 {
    ...
    public GeneticoRP1(int tamPob, double probMuta, int numGeneraciones) {
        this.tamPob = tamPob;
    ...
    public void evolucionar(){
        //try {
            ...
            this.pobActual.calcularMejorPeor();
...
for(int g=0; g<this.numGeneraciones;g++){
    ...
    int[] mask = Mascaras.generarMascaraAleatoria(13);
...
System.out.println("Mejor mejor: "+mejor.getFitness());
         ...
         try {
             ...
             Logger.getLogger(GeneticoRP1.class.getName()).log(Level.SEVERE, null, ex);
         }
